...
def main():
 ...
 with sync_playwright() as p:
  ...
  a5=next(s for s in reasoning if s['produced']=='A5');assert 'A3 et A4 portent tous deux le symbole soleil' in a5['text'] and 'trois symboles identiques consécutifs sont interdits' in a5['text'].lower() and 'TRIPLE CONSTRAINT' not in a5['text'],a5['text']

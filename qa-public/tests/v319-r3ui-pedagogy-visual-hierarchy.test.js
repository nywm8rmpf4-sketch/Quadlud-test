...
const unitToken='3.1.9-r3ui-causal-focus-r4',cssToken='3.1.9-r3ui-unit-context-r2',navigationToken='3.1.9-r3ui-unit-context-r2',bridgeToken='3.1.9-r3ui-progressive-proof-r3',playedToken='3.1.9-a13r6-single-proof';
...
const cacheMatch=sw.match(/const CACHE='([^']+)'/);assert(cacheMatch);assert.strictEqual(cacheMatch[1],'quadlud-v3.1.9-r3ui-hf3r2');

...
importScripts('./game-contract.js?v=3.1.8');
importScripts('./game-manifest.js?v=3.1.8');
importScripts('./game-registry.js?v=3.1.8');
importScripts('./logical-move.js?v=3.1.8');
importScripts('./queens-logic.js?v=3.1.8');
importScripts('./difficulty-rating.js?v=3.1.8');
importScripts('./queens-difficulty.js?v=3.1.8');
importScripts('./tango-logic.js?v=3.1.8');
importScripts('./tango-difficulty.js?v=3.1.8');
importScripts('./sudoku-logic.js?v=3.1.8');
importScripts('./sudoku-difficulty.js?v=3.1.8');
importScripts('./patches-logic.js?v=3.1.8');
importScripts('./patches-difficulty.js?v=3.1.8');
importScripts('./nonogram-logic.js?v=3.1.8');
importScripts('./nonogram-validation-solver.js?v=3.1.8');
importScripts('./nonogram-difficulty.js?v=3.1.8');
importScripts('./generation-common.js?v=3.1.8');
importScripts('./queens-qpool4.js?v=3.1.8');
importScripts('./queens-generator.js?v=3.1.8');
importScripts('./tango-diversity-pool.js?v=3.1.9-diversity-pilot-v1');
importScripts('./tango-generator.js?v=3.1.9-diversity-pilot-v1');
importScripts('./sudoku-generator.js?v=3.1.8');
importScripts('./patches-generator.js?v=3.1.8');
importScripts('./nonogram-generator.js?v=3.1.8');

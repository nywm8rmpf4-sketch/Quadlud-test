...
(function(root,factory){
  ...
  const VERSION=6,DATA_SCHEMA=9,DATA_VERSION='tango-tutor-cache-r8-sync4-cognitive-dag',SOURCE_POOL_VERSION='tango-runtime-pool-r8',MATERIALIZED_DAG_SCHEMA=1;
